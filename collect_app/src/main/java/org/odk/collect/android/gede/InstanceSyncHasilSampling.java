...
/**
 * Created by Septiawan Aji Pradan on 6/8/2017.
 */
 ...
 */
public class InstanceSyncHasilSampling extends AsyncTask<Void, String, String> {
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            ...
            File instancesPath = new File(Collect.SAMPEL);
